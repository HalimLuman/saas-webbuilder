...
const plans = [
  {
    ...
    monthlyPrice: 0,
    annualPrice: 0,
    description: "Try & launch your first site",
    badge: null,
    highlighted: false,
    features: {
      websites: "1 website",
      pages: "2 pages per site",
      customDomain: false,
      branding: "Included",
      aiCredits: "20 credits/month",
  ...
  },
  {
    ...
    monthlyPrice: 5,
    annualPrice: 4,
    description: "Freelancer Starter",
    badge: "Most Popular",
    highlighted: true,
    features: {
      websites: "3 websites",
      pages: "20 pages per site",
      customDomain: true,
      branding: "Removed",
      aiCredits: "150 credits/month",
      templates: "Pro templates & sections",
      cms: "Basic CMS",
      codeExport: true,
      team: false,
      workflows: false,
  ...
  },
  {
    ...
    monthlyPrice: 15,
    annualPrice: 12,
    description: "Scale and make money",
    badge: null,
    highlighted: false,
    features: {
  ...
  },
  {
    ...
    monthlyPrice: null,
    annualPrice: null,
    description: "Custom high-tier solution",
    badge: null,
    highlighted: false,
    features: {
...
const comparisonFeatures = [
  ...
  { label: "Pages per Site", key: "pages" },
  { label: "Custom Domain", key: "customDomain" },
  { label: "Platform Branding", key: "branding" },
  { label: "AI Credits", key: "aiCredits" },
  { label: "Templates", key: "templates" },
  { label: "CMS Capabilities", key: "cms" },
  { label: "Code Export", key: "codeExport" },
  { label: "Team Collaboration", key: "team" },
  { label: "Workflows & Automations", key: "workflows" },
  { label: "Version History", key: "history" },
              ...
              >
                ...
                <ul className="space-y-2.5 mb-8 flex-1">
                  {[
                    ...
                    plan.features.customDomain ? "Custom domain included" : "No custom domain",
                    plan.features.aiCredits,
                    plan.features.templates,
                    plan.features.cms || "No CMS",
                  ].map((feature) => (
